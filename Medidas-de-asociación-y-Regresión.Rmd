---
title: "Medidas de asociación y Regresión"
...
```{r, echo = FALSE, comment=NA, warning=F, eval=TRUE, message= FALSE}
...
```{r, echo = FALSE, comment=NA, warning=F, eval=TRUE, message= FALSE, fig.align='center',fig.width=6,fig.height=4}
op <- par(mar=c(4,4,2,2),cex = 0.8)
data(soil)
...
```{r, echo = FALSE, comment=NA,fig.align='center', fig.height=4,fig.width=6}
op <- par(mar = c(4,4,2,2),cex = 0.8)
...
```{r, echo = FALSE, comment=NA,fig.align='center', fig.height=4,fig.width=6,warning=FALSE,message=F}
datos %>%
